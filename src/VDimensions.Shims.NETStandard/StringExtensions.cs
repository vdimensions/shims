namespace System
{
    ...
    public static class StringExtensions
    {
        ...
        /// One of the <see cref="StringComparison"/> enumeration values that determines how <paramref name="oldValue"/>
        ...
        public static string Replace(
            ...
            this 
            #endif
            string current, string oldValue, string newValue, StringComparison comparison)
        {
            if (current == null)
            {
